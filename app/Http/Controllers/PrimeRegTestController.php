...
use App\Http\Traits\PrimeRegTest\InputTextTestTrait;
...
class PrimeRegTestController extends Controller
{
    use InputTextTestTrait;
    ...
    public function index(Request $request): Response
    {
        try {
            ...
            return Inertia::render('PrimeRegTest', [
                'widgets' => $renderedWidgets,
                'pageTitle' => 'APEX Core Widgets Test - PrimeReg',
                'pageDescription' => 'Testing APEX Core widget implementations using WidgetRenderer'
            ]);
        } catch (\Exception $e) {
            Log::error('Error in PrimeRegTestController index method', [
                'file' => 'app/Http/Controllers/PrimeRegTestController.php',
                'method' => 'index',
                'error' => $e->getMessage(),
